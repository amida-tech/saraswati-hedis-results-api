...
//     },
//     usersGroups: ['General'],
//    // 'General is the default user, gives them the ability to view the base model of features.
//     created_on: new Date(Date.now()),
//     lastUpdated: new Date(Date.now()),
//     active: true,
//   },
...
//   region: 'US - New York',
// // if not a test user the role should be either a business User, Business Admin, Super Admin
